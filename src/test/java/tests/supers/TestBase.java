...
public class TestBase {
	...
	protected void initDriverPath() {
		...
		if (System.getProperty("os.name").toLowerCase().matches(".*windows.*")) {
			...
			System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "/Profile/NotWindows/chromedriver");
			System.setProperty("webdriver.gecko.driver", System.getProperty("user.dir") + "/Profile/NotWindows/geckodriver");
		}
	}
